...
INSERT IGNORE INTO users (username, email, password, roles, is_admin) 
...
-- Add test game
INSERT IGNORE INTO games (id, name, description) 
VALUES (1, 'Test Game', 'This is a test game for development purposes');

-- Add test chapter
INSERT IGNORE INTO chapters (id, game_id, sequence_number, title, description)
VALUES (1, 1, 1, 'Chapter 1', 'The first chapter of the test game');

-- Add test beat
INSERT IGNORE INTO beats (id, chapter_id, sequence_number, title, content)
VALUES (1, 1, 1, 'Beat 1', 'The first beat of the first chapter');

-- Add test post
INSERT IGNORE INTO posts (beat_id, author_id, title, content, post_type)
